...
export default function HomeScreen({ navigation }) {
  ...
  return (
    <View>
      ...
      <TouchableOpacity style={styles.addTask} onPress={onPressAddTask}>
        ...
        {dateData.map((element) => {
          ...
          return (
            <TouchableOpacity
              onPress={onPress}
              style={
                selectedDay === element["order"]
                  ? styles.selectedDateObject
                  : styles.dateObject
              }
            >
              <Text
